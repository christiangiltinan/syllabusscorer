...
const SEED_RESOURCES = [
  ...
  // Irish Past Papers
  { id: 'res7', name: 'JC Irish (HL) SEC 2014 Paper 1', type: 'Past Paper', system: 'Junior Cycle', subject: 'gaeilge', level: 'HL', topic: 'Official SEC Paper', chapter: 'Past Paper', url: '/assets/past_papers/gaeilge/higherlevel.p1.2014.pdf' },
  { id: 'res8', name: 'JC Irish (HL) SEC 2014 Paper 2', type: 'Past Paper', system: 'Junior Cycle', subject: 'gaeilge', level: 'HL', topic: 'Official SEC Paper', chapter: 'Past Paper', url: '/assets/past_papers/gaeilge/higherlevel.p2.2014.pdf' },
  { id: 'res9', name: 'JC Irish (OL) SEC 2014', type: 'Past Paper', system: 'Junior Cycle', subject: 'gaeilge', level: 'OL', topic: 'Official SEC Paper', chapter: 'Past Paper', url: '/assets/past_papers/gaeilge/ordinarylevel.2014.pdf' },
  { id: 'res10', name: 'JC Irish (FL) SEC 2014', type: 'Past Paper', system: 'Junior Cycle', subject: 'gaeilge', level: 'FL', topic: 'Official SEC Paper', chapter: 'Past Paper', url: '/assets/past_papers/gaeilge/foundationlevel.2014.pdf' },
  { id: 'res11', name: 'JC Irish (HL) SEC 2013 Paper 1', type: 'Past Paper', system: 'Junior Cycle', subject: 'gaeilge', level: 'HL', topic: 'Official SEC Paper', chapter: 'Past Paper', url: '/assets/past_papers/gaeilge/higherlevel.p1.2013.pdf' },
  { id: 'res12', name: 'JC Irish (HL) SEC 2013 Paper 2', type: 'Past Paper', system: 'Junior Cycle', subject: 'gaeilge', level: 'HL', topic: 'Official SEC Paper', chapter: 'Past Paper', url: '/assets/past_papers/gaeilge/higherlevel.p2.2013.pdf' },
  { id: 'res13', name: 'JC Irish (OL) SEC 2013', type: 'Past Paper', system: 'Junior Cycle', subject: 'gaeilge', level: 'OL', topic: 'Official SEC Paper', chapter: 'Past Paper', url: '/assets/past_papers/gaeilge/ordinarylevel.2013.pdf' },
  { id: 'res14', name: 'JC Irish (FL) SEC 2013', type: 'Past Paper', system: 'Junior Cycle', subject: 'gaeilge', level: 'FL', topic: 'Official SEC Paper', chapter: 'Past Paper', url: '/assets/past_papers/gaeilge/foundationlevel.2013.pdf' }
];
